...
export const profileStyles = {
  ...
  headerRow: "flex justify-between items-start border-b border-gray-100 pb-5 mb-6",
  ...
  gridForm: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4 mb-8",
  formHeading: "text-sm font-bold text-gray-900 border-b border-gray-100 pb-2 mb-4 col-span-full",
  ...
  select: "w-full border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-700 bg-white focus:outline-none focus:border-[#7B2CBF] focus:ring-1 focus:ring-[#7B2CBF] appearance-none transition-all cursor-pointer",
  ...
  phoneLeft: "flex items-center space-x-1.5 bg-gray-50 border-r border-gray-200 px-3 py-2 text-sm text-gray-700 cursor-pointer",
  ...
  noticeText: "text-[11px] text-orange-500 font-medium mt-2 col-span-full",
  checkboxRow: "flex items-center space-x-3 pt-6 border-t border-gray-100 mt-6",
